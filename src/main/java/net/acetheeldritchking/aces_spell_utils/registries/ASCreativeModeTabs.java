    ...
    public static final Supplier<CreativeModeTab> ASU_ITEMS_TAB = CREATIVE_MODE_TAB.register("asu_item_tabs",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ExampleItemRegistry.EXAMPLE_SHEATH.get()))
                    ...
                    .displayItems((itemDisplayParameters, output) -> {
                        ...
                        output.accept(ExampleItemRegistry.EXAMPLE_IMPACT_FRAME_WHITE.get());
                        output.accept(ExampleItemRegistry.EXAMPLE_IMPACT_FRAME_RED.get());
                        output.accept(ExampleItemRegistry.EXAMPLE_IMPACT_FRAME_BLUE.get());
                        output.accept(ExampleItemRegistry.EXAMPLE_IMPACT_FRAME_GREEN.get());
                        ...
                        output.accept(ExampleItemRegistry.EXAMPLE_RIBBON.get());
                        output.accept(ExampleItemRegistry.EXAMPLE_ROAR.get());
                        output.accept(ExampleItemRegistry.EXAMPLE_ROAR_RING.get());
                        output.accept(ExampleItemRegistry.EXAMPLE_DOME.get());
                        // Armor
