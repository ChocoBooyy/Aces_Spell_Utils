...
public class PassiveAbilityUniqueSpellbook extends PassiveAbilitySpellbook implements UniqueItem {
    List<SpellData> spellData = null;
    SpellDataRegistryHolder[] spellDataRegistryHolders;

    public PassiveAbilityUniqueSpellbook(SpellDataRegistryHolder[] spellDataRegistryHolders, Item.Properties properties)
    {
        super(spellDataRegistryHolders.length, properties);
        this.spellDataRegistryHolders = spellDataRegistryHolders;
    }

    public PassiveAbilityUniqueSpellbook(SpellDataRegistryHolder[] spellDataRegistryHolders, int additionalSlots, Item.Properties properties)
    {
